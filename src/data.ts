...
export const MATCH_FIXTURES: Match[] = [
  // Round 1
  { id: 'm-1', local: 'México', visitante: 'Sudáfrica', fecha: 'Jue 11/6, 13:00', grupo: 'Grupo A', jugado: true, marcadorReal: { golesLocal: 2, golesVisitante: 1 }, onceInicialReal: [] },
  { id: 'm-2', local: 'Corea del Sur', visitante: 'República Checa', fecha: 'Jue 11/6, 20:00', grupo: 'Grupo A', jugado: true, marcadorReal: { golesLocal: 1, golesVisitante: 1 }, onceInicialReal: [] },
  { id: 'm-3', local: 'Canadá', visitante: 'Bosnia y Herzegovina', fecha: 'Vie 12/6, 13:00', grupo: 'Grupo B', jugado: true, marcadorReal: { golesLocal: 2, golesVisitante: 0 }, onceInicialReal: [] },
  { id: 'm-4', local: 'Estados Unidos', visitante: 'Paraguay', fecha: 'Vie 12/6, 19:00', grupo: 'Grupo D', jugado: true, marcadorReal: { golesLocal: 3, golesVisitante: 1 }, onceInicialReal: [] },
  
  { id: 'm-5', local: 'Catar', visitante: 'Suiza', fecha: 'Sáb 13/6, 13:00', grupo: 'Grupo B', jugado: true, marcadorReal: { golesLocal: 0, golesVisitante: 2 }, onceInicialReal: [] },
  { id: 'm-6', local: 'Brasil', visitante: 'Marruecos', fecha: 'Sáb 13/6, 16:00', grupo: 'Grupo C', jugado: true, marcadorReal: { golesLocal: 2, golesVisitante: 2 }, onceInicialReal: [] },
  { id: 'm-7', local: 'Haití', visitante: 'Escocia', fecha: 'Sáb 13/6, 19:00', grupo: 'Grupo C', jugado: true, marcadorReal: { golesLocal: 1, golesVisitante: 2 }, onceInicialReal: [] },
  { id: 'm-8', local: 'Australia', visitante: 'Turquía', fecha: 'Sáb 13/6, 22:00', grupo: 'Grupo D', jugado: true, marcadorReal: { golesLocal: 1, golesVisitante: 2 }, onceInicialReal: [] },

  { id: 'm-9', local: 'Alemania', visitante: 'Curazao', fecha: 'Dom 14/6, 11:00', grupo: 'Grupo E', jugado: true, marcadorReal: { golesLocal: 4, golesVisitante: 0 }, onceInicialReal: [] },
  { id: 'm-10', local: 'Países Bajos', visitante: 'Japón', fecha: 'Dom 14/6, 14:00', grupo: 'Grupo F', jugado: true, marcadorReal: { golesLocal: 1, golesVisitante: 1 }, onceInicialReal: [] },
  { id: 'm-11', local: 'Costa de Marfil', visitante: 'Ecuador', fecha: 'Dom 14/6, 17:05', grupo: 'Grupo E', jugado: true, marcadorReal: { golesLocal: 1, golesVisitante: 2 }, onceInicialReal: [] },
  { id: 'm-12', local: 'Suecia', visitante: 'Túnez', fecha: 'Dom 14/6, 20:00', grupo: 'Grupo F', jugado: true, marcadorReal: { golesLocal: 3, golesVisitante: 1 }, onceInicialReal: [] },

  { id: 'm-13', local: 'España', visitante: 'Cabo Verde', fecha: 'Lun 15/6, 10:00', grupo: 'Grupo H', jugado: true, marcadorReal: { golesLocal: 3, golesVisitante: 0 }, onceInicialReal: [] },
  { id: 'm-14', local: 'Bélgica', visitante: 'Egipto', fecha: 'Lun 15/6, 13:00', grupo: 'Grupo G', jugado: true, marcadorReal: { golesLocal: 2, golesVisitante: 1 }, onceInicialReal: [] },
  { id: 'm-15', local: 'Arabia Saudita', visitante: 'Uruguay', fecha: 'Lun 15/6, 16:00', grupo: 'Grupo H', jugado: true, marcadorReal: { golesLocal: 1, golesVisitante: 3 }, onceInicialReal: [] },
  { id: 'm-16', local: 'Irán', visitante: 'Nueva Zelanda', fecha: 'Lun 15/6, 19:00', grupo: 'Grupo G', jugado: true, marcadorReal: { golesLocal: 1, golesVisitante: 1 }, onceInicialReal: [] },

  { id: 'm-17', local: 'Francia', visitante: 'Senegal', fecha: 'Mar 16/6, 13:00', grupo: 'Grupo I', jugado: true, marcadorReal: { golesLocal: 3, golesVisitante: 1 }, onceInicialReal: [] },
  { id: 'm-18', local: 'Irak', visitante: 'Noruega', fecha: 'Mar 16/6, 16:05', grupo: 'Grupo I', jugado: true, marcadorReal: { golesLocal: 1, golesVisitante: 2 }, onceInicialReal: [] },
  { id: 'm-19', local: 'Argentina', visitante: 'Argelia', fecha: 'Mar 16/6, 19:00', grupo: 'Grupo J', jugado: true, marcadorReal: { golesLocal: 3, golesVisitante: 0 }, onceInicialReal: [] },
  { id: 'm-20', local: 'Austria', visitante: 'Jordania', fecha: 'Mar 16/6, 22:00', grupo: 'Grupo J', jugado: true, marcadorReal: { golesLocal: 2, golesVisitante: 0 }, onceInicialReal: [] },

  { id: 'm-21', local: 'Portugal', visitante: 'RD Congo', fecha: 'Mié 17/6, 11:00', grupo: 'Grupo K', jugado: true, marcadorReal: { golesLocal: 4, golesVisitante: 1 }, onceInicialReal: [] },
  { id: 'm-22', local: 'Inglaterra', visitante: 'Croacia', fecha: 'Mié 17/6, 14:00', grupo: 'Grupo L', jugado: true, marcadorReal: { golesLocal: 2, golesVisitante: 1 }, onceInicialReal: [] },
  { id: 'm-23', local: 'Ghana', visitante: 'Panamá', fecha: 'Mié 17/6, 17:05', grupo: 'Grupo L', jugado: true, marcadorReal: { golesLocal: 2, golesVisitante: 2 }, onceInicialReal: [] },
  { id: 'm-24', local: 'Uzbekistán', visitante: 'Colombia', fecha: 'Mié 17/6, 20:00', grupo: 'Grupo K', jugado: true, marcadorReal: { golesLocal: 0, golesVisitante: 3 }, onceInicialReal: [] },

  // Round 2 & 3 Selection
  { id: 'm-25', local: 'México', visitante: 'Corea del Sur', fecha: 'Jue 18/6, 19:00', grupo: 'Grupo A', jugado: true, marcadorReal: { golesLocal: 2, golesVisitante: 2 }, onceInicialReal: [] },
  { id: 'm-26', local: 'Canadá', visitante: 'Catar', fecha: 'Jue 18/6, 16:00', grupo: 'Grupo B', jugado: true, marcadorReal: { golesLocal: 1, golesVisitante: 1 }, onceInicialReal: [] },
  { id: 'm-27', local: 'Estados Unidos', visitante: 'Australia', fecha: 'Vie 19/6, 13:00', grupo: 'Grupo D', jugado: true, marcadorReal: { golesLocal: 2, golesVisitante: 1 }, onceInicialReal: [] },
  { id: 'm-28', local: 'Brasil', visitante: 'Haití', fecha: 'Vie 19/6, 19:00', grupo: 'Grupo C', jugado: true, marcadorReal: { golesLocal: 5, golesVisitante: 0 }, onceInicialReal: [] },
  { id: 'm-29', local: 'Alemania', visitante: 'Costa de Marfil', fecha: 'Sáb 20/6, 14:00', grupo: 'Grupo E', jugado: true, marcadorReal: { golesLocal: 3, golesVisitante: 1 }, onceInicialReal: [] },
  { id: 'm-30', local: 'Países Bajos', visitante: 'Suecia', fecha: 'Sáb 20/6, 11:00', grupo: 'Grupo F', jugado: true, marcadorReal: { golesLocal: 2, golesVisitante: 1 }, onceInicialReal: [] },
  { id: 'm-31', local: 'España', visitante: 'Arabia Saudita', fecha: 'Dom 21/6, 11:00', grupo: 'Grupo H', jugado: true, marcadorReal: { golesLocal: 4, golesVisitante: 0 }, onceInicialReal: [] },
  { id: 'm-32', local: 'Argentina', visitante: 'Austria', fecha: 'Lun 22/6, 11:00', grupo: 'Grupo J', jugado: true, marcadorReal: { golesLocal: 2, golesVisitante: 1 }, onceInicialReal: [] },
  { id: 'm-33', local: 'Francia', visitante: 'Irak', fecha: 'Lun 22/6, 15:00', grupo: 'Grupo I', jugado: true, marcadorReal: { golesLocal: 4, golesVisitante: 0 }, onceInicialReal: [] },
  { id: 'm-34', local: 'Portugal', visitante: 'Uzbekistán', fecha: 'Mar 23/6, 11:00', grupo: 'Grupo K', jugado: true, marcadorReal: { golesLocal: 3, golesVisitante: 1 }, onceInicialReal: [] },
  { id: 'm-35', local: 'Colombia', visitante: 'RD Congo', fecha: 'Mar 23/6, 20:00', grupo: 'Grupo K', jugado: true, marcadorReal: { golesLocal: 2, golesVisitante: 1 }, onceInicialReal: [] },
  { id: 'm-36', local: 'Panamá', visitante: 'Inglaterra', fecha: 'Sáb 27/6, 15:05', grupo: 'Grupo L', jugado: true, marcadorReal: { golesLocal: 0, golesVisitante: 3 }, onceInicialReal: [] }
];
