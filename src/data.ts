...
// Complete World Cup 16th-finals (Dieciseisavos de Final) & Octavos de Final Calendar
export const KNOCKOUT_FIXTURES: Match[] = [
  {
    ...
    onceInicialReal: [],
    jugado: true,
    marcadorReal: { golesLocal: 0, golesVisitante: 1 },
  ...
  },
  {
    ...
    onceInicialReal: [],
    jugado: true,
    marcadorReal: { golesLocal: 1, golesVisitante: 1 },
    penalesReal: { penalesLocal: 3, penalesVisitante: 4 },
    detallesExtra: '(3) - (4) en penales',
  ...
  },
  {
    ...
    jugado: true,
    marcadorReal: { golesLocal: 1, golesVisitante: 1 },
    penalesReal: { penalesLocal: 2, penalesVisitante: 3 },
    detallesExtra: '(2) - (3) en penales',
  ...
  },
  {
    ...
    onceInicialReal: [],
    jugado: true,
    marcadorReal: { golesLocal: 3, golesVisitante: 0 },
  ...
  },
  {
    ...
    onceInicialReal: [],
    jugado: true,
    marcadorReal: { golesLocal: 3, golesVisitante: 2 },
  ...
  },
  {
    ...
    jugado: true,
    marcadorReal: { golesLocal: 3, golesVisitante: 2 },
    detallesExtra: 'Tiempos Extras (3-2)',
  ...
  },
  {
    ...
    onceInicialReal: [],
    jugado: true,
    marcadorReal: { golesLocal: 1, golesVisitante: 0 },
  ...
  },
  {
    ...
    jugado: true,
    marcadorReal: { golesLocal: 1, golesVisitante: 1 },
    penalesReal: { penalesLocal: 2, penalesVisitante: 4 },
    detallesExtra: '(2) - (4) en penales',
  ...
  // Octavos de Final (Sincronizado e Incorporado para Pronósticos y Fixture)
  {
    id: 'ko-17',
    local: 'Canadá',
    visitante: 'Marruecos',
  ...
  },
  {
    ...
    onceInicialReal: [],
    jugado: true,
    marcadorReal: { golesLocal: 0, golesVisitante: 2 },
  ...
  },
  {
    ...
    onceInicialReal: [],
    jugado: true,
    marcadorReal: { golesLocal: 1, golesVisitante: 3 },
    equipo_local: 'Brasil',
    equipo_visitante: 'Noruega',
    hora_ect: '14:00 ECT',
    estadio: 'Dallas Stadium',
  ...
  },
  {
    ...
    onceInicialReal: [],
    jugado: true,
    marcadorReal: { golesLocal: 2, golesVisitante: 2 },
    penalesReal: { penalesLocal: 4, penalesVisitante: 5 },
    detallesExtra: '(4) - (5) en penales',
    equipo_local: 'Portugal',
  ...
  // Cuartos de Final (Nuevos Fixtures del Mundial 2026™)
  {
    id: 'ko-25',
    local: 'Francia',
    visitante: 'Marruecos',
